...
The Entity Framework Core Fluent API `HasValue` method is used to configure discriminator values for entities in an [inheritance hierarchy](/modeling/inheritance) when a [table per hierarchy](/modeling/inheritance-table-per-hierarchy) approach is chosen for mapping inheritance to a database.
...
#### Further Reading
- [Inheritance](/modeling/inheritance)
