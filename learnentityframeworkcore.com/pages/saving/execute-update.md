...
It is useful when you want to update one or more properties (columns) for all rows that match a query.
...
This updates all blogs that contain only posts published before 2018.
...
Is `ExecuteUpdate` a real “Bulk Update”? Not quite. Yes, it updates rows in bulk directly in SQL. However, it **does not** bulk update entities with their own per-row values like [BulkUpdate](https://entityframework-extensions.net/bulk-update) (Entity Framework Extensions).
...
- [4:25](https://www.youtube.com/watch?v=VYitXAc_htI&t=265) — Why `SaveChangesAsync()` is not needed after `ExecuteUpdateAsync()`
...
- [6:20](https://www.youtube.com/watch?v=o9B3pxVpPIY&t=380) — Starting the `ExecuteUpdate` example after reviewing existing rows
- [8:12](https://www.youtube.com/watch?v=o9B3pxVpPIY&t=492) — First `SetProperty`: assigning the update timestamp
- [8:35](https://www.youtube.com/watch?v=o9B3pxVpPIY&t=515) — Second `SetProperty`: appending text and reviewing the generated SQL
- [9:08](https://www.youtube.com/watch?v=o9B3pxVpPIY&t=548) — Verifying updated rows in SQL Server
