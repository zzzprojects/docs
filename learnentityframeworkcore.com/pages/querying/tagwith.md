...
| `TagWithCallSite()` | The source file and line number automatically | You want to locate the query in your source code                    |
...
* Use `TagWithCallSite()` when you want EF Core to include the source file and line number automatically.
