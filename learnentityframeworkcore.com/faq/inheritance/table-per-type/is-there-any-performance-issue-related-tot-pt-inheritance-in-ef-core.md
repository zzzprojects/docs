...
The `TPT` inheritance is often considered slower than [TPC](https://www.learnentityframeworkcore.com/modeling/inheritance-table-per-concrete-type) and [TPH](https://www.learnentityframeworkcore.com/modeling/inheritance-table-per-hierarchy).
