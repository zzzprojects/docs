...
⚠️ **Note:** There is a known [dependency injection bug](https://github.com/aspnet/Extensions/issues/2431) when upgrading to .NET Core 3.0. As a temporary workaround, you can use the Autofac container until the issue is resolved.

---

# Dapper.Extensions

GitHub Repository: [Dapper.Extensions](https://github.com/ZeeLyn/Dapper.Extensions)
