...
<a class="btn btn-lg btn-z" role="button" href="http://dapper-plus.net/download" onclick="ga('send', 'event', { eventAction: 'download'});">
...
A perpetual license can be purchased from here: <a href="http://dapper-plus.net/pricing">Buy</a>